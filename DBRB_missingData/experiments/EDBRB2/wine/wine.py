from EDBRB2.differential_evolution_only_params import run_DE_algorithm_only_params
from EDBRB2.differential_evolution import run_DE_algorithm
from EDBRB2.ebrb import EDBRBClassifier
...
def cross_validation():
    ...
    for train_index, test_index in kf.split(X):
        ...
        ebrb = run_DE_algorithm(train_X, train_y, 3, 20, 100)  # 评价指标个数
