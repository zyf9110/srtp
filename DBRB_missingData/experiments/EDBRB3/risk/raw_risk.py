...
from datasets.load_data import load_raw_risk
...
def random_miss(X, y, miss_percent, miss_feature_nums=1):
    ...
    for train_index, test_index in kf.split(X_):
        ...
        print(temp_a)
        print(temp_a, '  ', temp_a[1][1] / (temp_a[1][1] + temp_a[1][0]+1e-6))
        if temp_a[1][1] + temp_a[1][0]>0:
...
for i in range(90,100):
    print("--------i=",i,"----")
    best, avg = random_miss_CV(i*0.01, 134)
    best_acc.append(best)
    avg_acc.append(avg)
print(best_acc)
print(avg_acc)