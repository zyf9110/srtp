...
from datasets.load_data import load_risk2
...
def random_miss(X, y, miss_percent, miss_feature_nums=1):
    ...
    sigma = [0.07381956264940165, 0.08345116778666217, 0.07277855204653061, 0.06758829813977531, 0.06524178038996567, 0.06743128370800587, 0.06441382121208447, 0.06389345520872261, 0.06228639962178041, 0.06788016911994048, 0.07851040375640896, 0.058275646535720135, 0.06045135430077677, 0.053951450741129794, 0.06002665478309525]
...
for i in range(9):
    best, avg = random_miss_CV((i+1)/10, 15)
    best_acc.append(best)
    avg_acc.append(avg)
print(best_acc)
print(avg_acc)