...
from datasets.load_data import load_risk3
...
def random_miss(X, y, miss_percent, miss_feature_nums=1):
    ...
    kf = KFold(n_splits=N_SPLITS, shuffle=True)
    sigma = [0.08315140327325592, 0.09400058002523448, 0.08197879415252486, 0.07613241847375078, 0.07348926757039256, 0.07595555518890866, 0.07255664259913976, 0.0719704949461018, 0.07016028472002629, 0.07646118608906084, 0.08843523328498375, 0.06809326362107763, 0.0676148760555428]
...
for i in range(9):
    best, avg = random_miss_CV((i+1)/10, 13)
    best_acc.append(best)
    avg_acc.append(avg)
print(best_acc)
print(avg_acc)