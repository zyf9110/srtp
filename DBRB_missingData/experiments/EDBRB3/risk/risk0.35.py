...
from datasets.load_data import load_risk1
...
def random_miss(X, y, miss_percent, miss_feature_nums=1):
    ...
    sigma = [0.06737820132175897, 0.07616937004043854, 0.042108990314990796, 0.06642802741851518, 0.0616906656665726, 0.059548900805371056, 0.06154735202971961, 0.04514919838812131, 0.05879318784567188, 0.058318228037226055, 0.056851401209945654, 0.061957068513673566, 0.07165972813027471, 0.05319061917351041, 0.05517647861984091, 0.04924374487155364, 0.05478883761281536]
...
for i in range(9):
    best, avg = random_miss_CV((i+1)/10, 17)
    best_acc.append(best)
    avg_acc.append(avg)
print(best_acc)
print(avg_acc)